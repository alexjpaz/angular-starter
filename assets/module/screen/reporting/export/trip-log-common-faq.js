angular.module('vehimatics/screen').config(function(ScreenProvider, $provide) {
	...
	ScreenProvider.register('screen-trip-log-exporter-common-faq', {
		pageTitle: 'Trip Log Report',
		controller: function ($scope, $filter, $location, UserAccount, UserReports, VehicleReportingSingle, $injector, Collection, Storage, ReportsHelper, $animate) {
			...
			var 
			screenStorage = Storage.getInstance('screen-trip-log-exporter-faq'),
			deviceParam = {
				query: "HAS_DEVICE"
			};
			...
			$scope.topicModel = [
				{url:'what-is-a-trip-log'},
				{url:'trip-log-vs-trip-alert'},
				{url:'trip-log-vehicle-vs-trip-log-location'},
				{url:'sharing-a-vehimatics-report'},
				{url:'what-is-a-csv'},
				{url:'what-is-approximate-location-nearest-address'}
			];
